...
from humanoidverse.agents.modules.ppo_modules import PPOActorTanh, PPOCritic
...
class PPO_Tanh(BaseAlgo):
    ...
    def _get_action_scaling(self):
        ...
        action_bias = torch.zeros(self.num_act, device='cpu')
