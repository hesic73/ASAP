...
class PPOEstimator(PPO):
        ...
        if ckpt_path is not None:
            ...
            if self.load_optimizer:
                ...
                self.estimator_learning_rate = loaded_dict[
                    'estimator_optimizer_state_dict']['param_groups'][0]['lr']
                ...
                logger.info(
                    f"Estimator Learning rate: {self.estimator_learning_rate}")
    ...
    def _setup_storage(self):
        ...
        self.storage.register_key('estimator_output', shape=(
            self.algo_obs_dim_dict["estimator_target"],), dtype=torch.float)
    ...
    def _update_estimator(self, policy_state_dict, loss_dict):
        ...
        estimator_output = self.estimator(
    ...
    def _pre_eval_env_step(self, actor_state: dict):
        ...
        input_for_actor = torch.cat(
            [actor_state["obs"]['actor_obs'], estimator_output], dim=-1)
