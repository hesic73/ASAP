...
class DeltaDynamicsModel(BaseAlgo):
    ...
    def learn(self):
        ...
        for it in range(self.num_learning_iterations):
            ...
            self.writer.add_scalar(
                'Loss_base_pos_xyz', loss_base_pos_xyz.item(), it)
            self.writer.add_scalar(
                'Loss_base_lin_vel', loss_base_lin_vel.item(), it)
            self.writer.add_scalar(
                'Loss_base_ang_vel', loss_base_ang_vel.item(), it)
    ...
    def evaluate_policy(self):
        ...
        actor_state.update({"obs": obs_dict,
